        ...
        switch (season) {
            ...
            default: {
                switch (quadrum) {
                    ...
                    default:
                        Log.ErrorOnce(
                            $"NPSWeatherEffects: Could not find an appropriate weather settings for biome: {map.Biome} from mod: {map.Biome.modContentPack?.Name} Season: {season} Quadrum: {quadrum}",
